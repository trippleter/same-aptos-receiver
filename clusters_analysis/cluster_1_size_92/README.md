...
By looking at the dates of each transaction on Arbitrum network (different days and months, but always same date on each wallet), similar transaction amounts (0.03 ETH received on 2023/05/17-2023/05/18), use of Huobi in every wallet, 0 organic transactions (only airdrop farming/claiming), and same creation date shown by Debank (590 days as of May 27), and having the clustering by same Aptos wallet receiver method, we are 100% sure this indeed is a sybil cluster of 92 wallets.
